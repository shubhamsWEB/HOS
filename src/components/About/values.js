...
function Journey() {
    return (
        <Grid container spacing={{xs: 2, sm: 4}} p={{xs: 2, sm: 3, md: 4}}>
            ...
            <Grid item xs={12} sm={6}>
                <Box mt={{xs: 1.5, sm: 2}}>
                    <Typography variant='h6' fontWeight={'bold'} sx={{ borderLeft: '3px solid #B59A6C', pl: 1, fontSize: {xs: '0.875rem', sm: '1rem'} }} className={styles.sub}>Excellence</Typography>
                ...
                <Box mt={{xs: 2, sm: 3}}>
                    <Typography variant='h6' fontWeight={'bold'} sx={{ borderLeft: '3px solid #B59A6C', pl: 1, fontSize: {xs: '0.875rem', sm: '1rem'} }} className={styles.sub}>Integrity</Typography>
                    <Typography variant='subtitle1' className={styles.content}>
                ...
                <Box mt={{xs: 2, sm: 3}}>
                    <Typography variant='h6' fontWeight={'bold'} sx={{ borderLeft: '3px solid #B59A6C', pl: 1, fontSize: {xs: '0.875rem', sm: '1rem'} }} className={styles.sub}>Artistry</Typography>
                    <Typography variant='subtitle1' className={styles.content}>
                ...
                <Box mt={{xs: 2, sm: 3}}>
                    <Typography variant='h6' fontWeight={'bold'} sx={{ borderLeft: '3px solid #B59A6C', pl: 1, fontSize: {xs: '0.875rem', sm: '1rem'} }} className={styles.sub}>Customer-Centric</Typography>
                    <Typography variant='subtitle1' className={styles.content}>
                ...
                <Box mt={{xs: 2, sm: 3}}>
                    <Typography variant='h6' fontWeight={'bold'} sx={{ borderLeft: '3px solid #B59A6C', pl: 1, fontSize: {xs: '0.875rem', sm: '1rem'} }} className={styles.sub}>Ethical Sourcing</Typography>
                    <Typography variant='subtitle1' className={styles.content}>
                ...
                <Box mt={{xs: 2, sm: 3}}>
                    <Typography variant='h6' fontWeight={'bold'} sx={{ borderLeft: '3px solid #B59A6C', pl: 1, fontSize: {xs: '0.875rem', sm: '1rem'} }} className={styles.sub}>Personalization</Typography>
                    <Typography variant='subtitle1' className={styles.content}>
